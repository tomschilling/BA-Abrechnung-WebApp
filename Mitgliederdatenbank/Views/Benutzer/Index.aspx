    ...
    <div class="container-fluid">
      <div class="row">
       ...
       <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header alert ">Benutzer</h1>
          <div class="table-responsive">
               ...
               <table class="table table-striped table-bordered">
                ...
                <%For Each ben In Model.Benutzer%>
                    <tr>
                        <td><%= ben.IdPk%></td>
                        
                        <td><%= ben.Benutzername%></td>
                        <td><%= ben.IstVorgesetzter%></td>
                        <td><%= ben.IstAdmin%></td>
                        <td>
                            <%= Html.ActionLink("Bearbeiten", "Bearbeiten", New With {.id = ben.IdPk}, New With {.class = "btn btn-success", .role = "button"})%>
                            <%= Html.ActionLink("Löschen", "Loeschen", New With {.id = ben.IdPk}, New With {.class = "btn btn-danger", .role = "button"})%>  
                             </td>
                    </tr>
                <%Next%>
                </table>
