    ...
    <div class="container-fluid">
      <div class="row">
       ...
       <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h1 class="page-header alert ">Benutzer "<%= Model.Benutzername%>" bearbeiten</h1>
                ...
                <div class="row">
                     <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <%= Html.TextBox("Benutzername", Model.Benutzername, New With {.class = "form-control"})%>
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <%= Html.TextBox("Passwort", Model.Passwort, New With {.class = "form-control", .type = "password"})%>
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            <%= Html.CheckBox("IstAdmin", Model.IstAdmin)%>
