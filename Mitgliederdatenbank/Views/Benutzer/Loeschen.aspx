<%@ Page Language="VB" Inherits="System.Web.Mvc.ViewPage(Of Mitgliederdatenbank.Benutzer)" %>

<!DOCTYPE html>

<html>
<head id="Head1"  runat="server">
    <title>Benutzer "<%=Html.Encode(Model.Benutzername)%>" löschen - Mitgliederdatenbank</title>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <h1 class="page-header alert ">Benutzer löschen</h1>
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <%= Html.TextBox("Benutzername", Model.Benutzername, New With {.class = "form-control", .disabled = "disabled"})%>
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            ...
                            <%= Html.TextBox("Passwort", Model.Passwort, New With {.class = "form-control", .type = "password", .disabled = "disabled"})%>
                ...
                <div class="row">
                    <div class="col-sm-2">
                        <div class="form-group">
                            <%= Html.CheckBox("IstAdmin", Model.IstAdmin, New With {.class = "disabled", .disabled = "disabled"})%>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Benutzer "<%=Html.Encode(Model.Benutzername)%>" löschen</h4>
                            </div>
                            <div class="modal-body">
                                <p>Möchten Sie den Benutzer "<%=Html.Encode(Model.Benutzername)%>" wirklich löschen?</p>
                            </div>
